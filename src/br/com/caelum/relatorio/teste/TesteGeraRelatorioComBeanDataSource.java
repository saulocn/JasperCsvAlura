...
public class TesteGeraRelatorioComBeanDataSource {
	...
	public static void main(String[] args) throws SQLException, JRException, FileNotFoundException {
		...
		List<MovimentacaoRelatorio> listRelatorio = new ArrayList<MovimentacaoRelatorio>();

		for (Movimentacao movimentacao : lista) {
			listRelatorio.add(new MovimentacaoRelatorio(movimentacao));
		}
		JRBeanCollectionDataSource dataSource = new JRBeanCollectionDataSource(listRelatorio);
